...
public class UsersFacade extends AbstractFacade<Users> 
{
    ...
    public Entry<Users, String> loginUser(String username, String password)
    {
        ...
        if(!ValidationUtils.isNotNull(username, password)||  !ValidationUtils.isInRange(username, 4, 16) ||  
                !ValidationUtils.isInRange(password, 6, 16)   ||  !ValidationUtils.isAlphanumeric(username, password))
            response    =   "Invalid input";
        else
        {
            user  =   find(username);
